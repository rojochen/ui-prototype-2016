(function () {
	...
	require.config({
		...
		paths: {
			...
			bouncedRecordCtrl: 'js/controller/bouncedRecord',
			LOASetCtrl: 'js/controller/LOASet',
			draftCtrl: 'js/controller/draft'
		}
	});
	require(['pokemon', 'btModule', 'btController', 'demoCtrl', 'footer', 'header', 'floatWindows', 'shoppingCartEntity', 'ITParameterSetCtrl', 'roleSetCtrl', 'userSetCtrl', 'groupsSetCtrl', 'marginSetCtrl', 'downtimeProbabilitySetCtrl', 'ARPBSetCtrl', 'renewalDateCtrl', 'changeLimitCtrl', 'salesSetCtrl', 'systemSetCtrl', 'classificationSetCtrl', 'activityClassificationCtrl', 'activityTypeCtrl', 'functionPermissionsSetCtrl', 'activityGroupCtrl', 'numberTypeCtrl', 'promotingGenerationTypeCtrl', 'classificationOfferSetCtrl', 'agreementAddCtrl', 'suitableTargetCtrl', 'giftActivityTypeCtrl', 'offerMutexSetCtrl', 'pnotifyService', 'discountConditionsCtrl', 'giftActivityItemCtrl', 'activemenuServiceCtrl', 'tableQueryCtrl', 'importDeviceCtrl', 'exportTableXMLCtrl', 'aPasteBackupCtrl', 'excelGlutChangeCtrl', 'conversionListCtrl', 'multiEditServiceCtrl', 'alreadyDealCtrl', 'npvStatusQueryCtrl', 'confirmBillCtrl', 'rejectBillCtrl', 'btDatepickerRange', 'btDatepicker', 'btDatepickerRange', 'activityClassSetCtrl', 'newSetCtrl', 'pageGearingSetCtrl', 'prepaidSetCtrl', 'specialSetCtrl', 'waitTreatmentListCtrl', 'forciblyCancellationCtrl', 'enforceTurnSingleCtrl', 'bouncedRecordCtrl', 'LOASetCtrl', 'draftCtrl'], function (pokemon, btModule, btController, demoCtrl, footer, header, floatWindows, shoppingCartEntity, ITParameterSetCtrl, roleSetCtrl, userSetCtrl, groupsSetCtrl, marginSetCtrl, downtimeProbabilitySetCtrl, ARPBSetCtrl, renewalDateCtrl, changeLimitCtrl, salesSetCtrl, systemSetCtrl, classificationCtrl, activityClassificationCtrl, activityTypeCtrl, functionPermissionsSetCtrl, activityGroupCtrl, numberTypeCtrl, promotingGenerationTypeCtrl, classificationOfferSetCtrl, agreementAddCtrl, suitableTargetCtrl, giftActivityTypeCtrl, offerMutexSetCtrl, pnotifyService, discountConditionsCtrl, giftActivityItemCtrl, activemenuServiceCtrl, tableQueryCtrl, importDeviceCtrl, exportTableXMLCtrl, aPasteBackupCtrl, excelGlutChangeCtrl, conversionListCtrl, multiEditServiceCtrl, alreadyDealCtrl, btDatepicker, btDatepickerRange, npvStatusQueryCtrl, confirmBillCtrl, rejectBillCtrl, activityClassSetCtrl, newSetCtrl, pageGearingSetCtrl, prepaidSetCtrl, specialSetCtrl, waitTreatmentListCtrl, forciblyCancellationCtrl, enforceTurnSingleCtrl, bouncedRecordCtrl, LOASetCtrl, draftCtrl) {
